        ...
        if self.email_status == False:
            ...
            return {
                ...
                'context': {'default_name': self.name,
                            'default_notice_content': '<p><p>Greetings,</p><br/><p>A New Article has been Published ' + name + ' Click to view</p><br/>   <a href="' + redirect_url + '" role="button" class="btn btn-primary">View</a> </p>',
